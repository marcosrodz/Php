<html>
    ...
    <body>
        <?php
            ...
            $valor = ["12,00","21,00","29,50","37,00","44,50","52,00","59,50","67,00","74,50","82","89,50"];
            print $totalmin.'<br/>';
            if($totalmin <= 60){
                $valor = $valor[0];
            }
                        ...
                        <div class="card-body">
                            <form action = "p.php" method = "POST">
                                ...
                                <table class="table table-dark table-striped">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><h5><?php echo $dados[$p];?></h5></td>
                                        <td><h5><?php echo $dados[$p1];?></h5></td>
                                        <td><h5><?php echo $dados[$p2].' : '.$dados[$p3];?></td>
                                        <td><h5><?php echo $dados[$p4].' : '.$dados[$p5];?></td>
                                    </tr>
                                    </tbody>
                                </table>
